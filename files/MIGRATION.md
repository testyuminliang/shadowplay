...
> 最近更新：2026-06-24 — v10 掌心/手背朝向判定（修复掌心正对镜头仍显示甲片）。
...
### v10 — 掌心/手背朝向判定（重做 v3，更稳）（2026-06-24，当前版本）
...
- **与 v3 的区别：** v3 是全局隐藏、太粗暴（弯指/猫爪也被隐藏）；本版判定更稳，且强弯曲手指本就被 v8 的 edge-on fade 隐藏，二者叠加行为合理。符号若与实机相反，用 Debug HUD 确认后翻常量。
...
- 仍待观察：掌心朝镜头但弯指（猫爪）露出指甲的极端姿势——目前被 v8 edge-on fade 隐藏，若需显示再单独处理
